/*GLOBAL VELOCITY NYA ENCODER  dan disini saya menggunakan mikrokontroller arduino due*/
...
void updateOdometry(void) {
  ...
  _x = WHEEL_RADIUS * 0.55 * (rvPos2 - rvPos3);
  _y = WHEEL_RADIUS * (2.0 / 3.0) * (rvPos1 - 0.45 * (rvPos2 + rvPos3));
